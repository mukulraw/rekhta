...
////=========================================================================================
     ...
     *
     */
    private class PinchHandler implements IScaleGestureDetector.IOnScaleGestureListener {
        ...
        private void animateChildrenHeight(int fromHeight, int toHeight, long duration) {
            final Animation.AnimationListener l = new Animation.AnimationListener() {
                /*
                 * (non-Javadoc)
                 * @see android.view.animation.Animation.AnimationListener#onAnimationEnd(android.view.animation.Animation)
                 */
